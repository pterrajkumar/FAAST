<app-agent-configuration>
    ...
    <sensitive-url-filters>
        <!--
            ...
            There can only be one sensitive-url-filter. A sensitive-url-filter element must have two attributes:
            ...
            match-filter - defaulted to NOT_EMPTY if not specified
    ...
    <agent-services>
        ...
        <agent-service name="JMXService" enabled="false">
            <configuration-properties>
                ...
                <property name="jmx-appserver-mbean-finder-delay-in-seconds" value="500"/>
        ...
        <agent-service name="AgentProxyService" enabled="true">
            <service-dependencies>TransactionMonitoringService,ObjectMonitoringService</service-dependencies>
            <configuration-properties>
